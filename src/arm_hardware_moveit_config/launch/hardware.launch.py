...
def generate_launch_description():
    ...
    package_name='arm_hardware_moveit_config'
    ...
    robot_description_semantic_config = load_file("arm_hardware_moveit_config", "config/robot_arm.srdf")
    robot_description_semantic = {"robot_description_semantic": robot_description_semantic_config }
    
    # Kinematics.yaml file:
    kinematics_yaml = load_yaml("arm_hardware_moveit_config", "config/kinematics.yaml")
    ...
    moveit_config = (
        MoveItConfigsBuilder("arm_hardware")
        .robot_description(
    ...
    rviz_base = os.path.join(get_package_share_directory("arm_hardware_moveit_config"), "config")
