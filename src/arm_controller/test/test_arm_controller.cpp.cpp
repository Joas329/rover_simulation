...
#include "test_arm_controller.cpp.hpp"
...
using arm_controller::CMD_MY_ITFS;
using arm_controller::control_mode_type;
using arm_controller::STATE_MY_ITFS;

class ArmController.cppTest : public ArmController.cppFixture<TestableArmController.cpp>
{
};

TEST_F(ArmController.cppTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(ArmController.cppTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(ArmController.cppTest, activate_success)
{
  SetUpController();
...
TEST_F(ArmController.cppTest, update_success)
{
  SetUpController();
...
TEST_F(ArmController.cppTest, deactivate_success)
{
  SetUpController();
...
TEST_F(ArmController.cppTest, reactivate_success)
{
  SetUpController();
...
TEST_F(ArmController.cppTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(ArmController.cppTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ArmController.cppTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ArmController.cppTest, publish_status_success)
{
  SetUpController();
...
TEST_F(ArmController.cppTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
