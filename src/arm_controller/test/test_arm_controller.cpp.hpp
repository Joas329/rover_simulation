...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ARM_CONTROLLER.CPP_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ARM_CONTROLLER.CPP_HPP_
...
#include "arm_controller/arm_controller.cpp.hpp"
...
using ControllerStateMsg = arm_controller::ArmController.cpp::ControllerStateMsg;
using ControllerReferenceMsg = arm_controller::ArmController.cpp::ControllerReferenceMsg;
using ControllerModeSrvType = arm_controller::ArmController.cpp::ControllerModeSrvType;
...
class TestableArmController.cpp : public arm_controller::ArmController.cpp
{
  FRIEND_TEST(ArmController.cppTest, all_parameters_set_configure_success);
  FRIEND_TEST(ArmController.cppTest, activate_success);
  FRIEND_TEST(ArmController.cppTest, reactivate_success);
  FRIEND_TEST(ArmController.cppTest, test_setting_slow_mode_service);
  FRIEND_TEST(ArmController.cppTest, test_update_logic_fast);
  FRIEND_TEST(ArmController.cppTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = arm_controller::ArmController.cpp::on_configure(previous_state);
...
class ArmController.cppFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_arm_controller.cpp/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_arm_controller.cpp/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_arm_controller.cpp")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_arm_controller.cpp/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableArmController.cpp> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ARM_CONTROLLER.CPP_HPP_
