...
#include "test_arm_controller.hpp"
...
class ArmControllerTest : public ArmControllerFixture<TestableArmController>
{
};

TEST_F(ArmControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(ArmControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(ArmControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(ArmControllerTest, update_success)
{
  SetUpController();
...
TEST_F(ArmControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(ArmControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(ArmControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(ArmControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ArmControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(ArmControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(ArmControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
