// Copyright (c) 2023, Joaquin Philco
...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ARM_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ARM_CONTROLLER_HPP_
...
using ControllerStateMsg = arm_controller::ArmController::ControllerStateMsg;
using ControllerReferenceMsg = arm_controller::ArmController::ControllerReferenceMsg;
using ControllerModeSrvType = arm_controller::ArmController::ControllerModeSrvType;
...
class TestableArmController : public arm_controller::ArmController
{
  FRIEND_TEST(ArmControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(ArmControllerTest, activate_success);
  FRIEND_TEST(ArmControllerTest, reactivate_success);
  FRIEND_TEST(ArmControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(ArmControllerTest, test_update_logic_fast);
  FRIEND_TEST(ArmControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = arm_controller::ArmController::on_configure(previous_state);
...
class ArmControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_arm_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_arm_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_arm_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_arm_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableArmController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ARM_CONTROLLER_HPP_
