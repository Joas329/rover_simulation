...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_YURS_ARM_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_YURS_ARM_CONTROLLER_HPP_
...
using ControllerStateMsg = yurs_arm_controller::YursArmController::ControllerStateMsg;
using ControllerReferenceMsg = yurs_arm_controller::YursArmController::ControllerReferenceMsg;
using ControllerModeSrvType = yurs_arm_controller::YursArmController::ControllerModeSrvType;
...
class TestableYursArmController : public yurs_arm_controller::YursArmController
{
  FRIEND_TEST(YursArmControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(YursArmControllerTest, activate_success);
  FRIEND_TEST(YursArmControllerTest, reactivate_success);
  FRIEND_TEST(YursArmControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(YursArmControllerTest, test_update_logic_fast);
  FRIEND_TEST(YursArmControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = yurs_arm_controller::YursArmController::on_configure(previous_state);
...
class YursArmControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_yurs_arm_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_yurs_arm_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_yurs_arm_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_yurs_arm_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableYursArmController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_YURS_ARM_CONTROLLER_HPP_
