...
void YursArmControllerTest::SetUpTestCase() { rclcpp::init(0, nullptr); }

void YursArmControllerTest::TearDownTestCase() { rclcpp::shutdown(); }

void YursArmControllerTest::SetUp()
{
  // initialize controller
  controller_ = std::make_unique<FriendYursArmController>();
}

void YursArmControllerTest::TearDown() { controller_.reset(nullptr); }
...
TEST_F(YursArmControllerTest, JointsParameterNotSet)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, InterfaceParameterNotSet)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, JointsParameterIsEmpty)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, InterfaceParameterEmpty)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, ConfigureParamsSuccess)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, ActivateWithWrongJointsNamesFails)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, ActivateWithWrongInterfaceNameFails)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, ActivateSuccess)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, CommandSuccessTest)
{
  SetUpController();
  ...
  // send command
  auto command_ptr = std::make_shared<yurs_arm_controller::CmdType>();
...
TEST_F(YursArmControllerTest, WrongCommandCheckTest)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, NoCommandCheckTest)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, CommandCallbackTest)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, ActivateDeactivateCommandsResetSuccess)
{
  SetUpController();
