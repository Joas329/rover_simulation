...
TEST_F(YursArmControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, update_success)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(YursArmControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(YursArmControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(YursArmControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
