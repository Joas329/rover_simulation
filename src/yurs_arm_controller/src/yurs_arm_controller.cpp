...
controller_interface::CallbackReturn YursArmController::on_init()
{
  control_mode_.initRT(control_mode_type::FAST);

  try
  {
    param_listener_ = std::make_shared<yurs_arm_controller::ParamListener>(get_node());
  }
...
controller_interface::CallbackReturn YursArmController::on_configure(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  ref_subscriber_ = get_node()->create_subscription<ControllerReferenceMsg>(
    ...
    std::bind(&YursArmController::reference_callback, this, std::placeholders::_1));
...
void YursArmController::reference_callback(const std::shared_ptr<ControllerReferenceMsg> msg)
{
...
controller_interface::InterfaceConfiguration YursArmController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration YursArmController::state_interface_configuration() const
{
...
controller_interface::CallbackReturn YursArmController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::CallbackReturn YursArmController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::return_type YursArmController::update(
