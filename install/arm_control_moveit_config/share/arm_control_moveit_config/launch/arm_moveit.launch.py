...
def generate_launch_description():
    ...
    gazebo = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory('my_bot'), 'launch'), '/arm_gazebo.launch.py']),
             )
    ...
    robot_state_publisher = Node(
        ...
        output="both",
        parameters=[robot_description, {"use_sim_tine": True}],
    )
    ...
    # arm_group_controller=ExecuteProcess(
    ...
    moveit_simple_controllers_yaml = load_yaml("arm_control_moveit_config", "config/moveit_controllers.yaml")
    moveit_controllers = {
